      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Features labeled <Badge tone="blue">Premium</Badge> require a
            Premium plan. Free plan limits are summarised below.
          </p>
        </header>
          ...
          <article className="lg:col-span-3 space-y-12">
            ...
            <section id="getting-started">
              ...
              <ol className="list-decimal pl-6 space-y-2">
                ...
                <li>
                  <strong>NFC</strong>{" "}
                  <Badge tone="blue">Premium</Badge>: optional tap-to-log
                  flow—see the NFC section below.
                </li>
              </ol>
            </section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-6">
                    <li>
                      <strong>Filter by Apiary</strong> to scope stats and
                      recent items; <em>Apiaries</em> count stays global.
                    </li>
                    <li>
                      <strong>Recent sections (Inspections, Tasks, Logbook):</strong>{" "}
                      “<em>Open →</em>” takes you to the relevant{" "}
                      <em>list</em> page with the item briefly{" "}
                      <strong>highlighted</strong>. Use <strong>✎ Edit</strong>{" "}
                      to jump to editing.
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Tasks</strong> show a status pill
                      (Pending/Completed) and an <strong>Overdue</strong> label
                      when past the due date.
                    </li>
                    <li>
                      <strong>Weather Snapshot</strong> uses your{" "}
                      <em>default apiary</em> and displays a banner naming it.
                      If the default has no coordinates, a clear note explains a
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6">
                    ...
                    <li>
                      If an NFC tag is linked, a small{" "}
                      <strong>NFC Tag</strong> pill appears on the hive card
                      (Premium), so you can see at a glance which hives are
                      tagged.
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6">
                    <li>
                      Filter by apiary and/or hive; each card summarises key
                      info and photos.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      the card can show a small <strong>NFC Tag</strong> pill,
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6">
                    ...
                    <li>
                      ...
                      the <strong>Task List</strong> (blue{" "}
                      <em>Mark complete</em> button) or from the{" "}
                      <strong>Edit Task</strong> page.
                    </li>
                    <li>
                      From the calendar, open an item and choose{" "}
                      <strong>View in list</strong> to jump to the Task List
                      with the task briefly highlighted.
                    </li>
                    <li>
                      The calendar surfaces dated items across apiaries and
                      hives. <Badge>Free</Badge>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    <br />
                    <span className="text-gray-700">
                      When linking a <em>Related Inspection</em>, the dropdown
                      is grouped by date and each option shows{" "}
                      <strong>Hive (Apiary)</strong> and the{" "}
                      <strong>time</strong>, making same-day inspections easy to
                      tell apart. Use the Hive selector above to narrow the
                      list.
                    </span>{" "}
                    <Badge>Free</Badge>
                  </p>
                  <ul className="list-disc pl-6 mt-2">
                    <li>
                      <strong>Arriving from Inspections:</strong> the Logbook
                      list may be <em>filtered to a specific inspection</em>{" "}
                      (via <em>View logbook</em>). You’ll see a blue banner with
                      the inspection ref/date, a{" "}
                      <em>Back to that inspection</em> link, and a{" "}
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6">
                    <li>
                      ...
                      <strong>Edit</strong> button in the table to update a
                      sale.
                    </li>
                    <li>
                      <strong>New Sale:</strong> add line items (qty, unit
                      price, discount, optional cost per unit). Totals display
                      in your <strong>default currency</strong>. After saving,
                      you’re returned to the <strong>Sales</strong> list.
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6">
                    ...
                    <li>
                      ...
                      in Sales totals and pre-fills in New Expense. You can
                      still override currency on individual expenses.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      CSV files for your tables plus a list of public photo
                      URLs.
                    </li>
                    <li>
            ...
            <section id="currency-defaults">
              ...
              <div className="space-y-2 text-gray-700">
                <p>
                  ...
                  entries. You can set it in <strong>Settings</strong>.
                  Examples: <code>GBP</code>, <code>EUR</code>,{" "}
                  <code>USD</code>.
                </p>
                <ul className="list-disc pl-6 space-y-1">
                  <li>
                  ...
                  <li>
                    ...
                    pre-filled with your default currency; you can change it per
                    expense.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Inventory List:</strong> rows display using the
                    item’s own currency; if an item has none saved, your default
                    currency is used.
                  </li>
                  <li>
            ...
            <section id="reports">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  ...
                  download CSVs of your tables (plus{" "}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ol className="list-decimal pl-6 space-y-1">
                    ...
                    <li>
                      Record observations, add photos (up to 3), and save.
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-6 space-y-1">
                    <li>
                      Open the <strong>Scan NFC</strong> page (Premium).
                    </li>
                    <li>
                      Tap the tag. If it isn’t linked to any hive yet, you’ll be
                      taken to <strong>New Hive</strong> with the tag ID
                      pre-filled and locked—choose the correct apiary, name the
                      hive, and save.
                    </li>
                    <li>
                  ...
                  <p className="text-gray-700 mt-2">
                    <strong>Future visits:</strong> once a hive is linked to a
                    tag, every tap on that tag always opens{" "}
                    <strong>New Inspection</strong> for that hive immediately.
                    The assumption is that if you’re at the hive scanning the
                    tag, you’re there to inspect it. You can still review past
                    inspections afterwards via the normal{" "}
                    <em>Inspections</em> pages.
                  </p>
                  <p className="text-gray-700 mt-2">
            ...
            <section id="nfc">
              ...
              <div className="space-y-3">
                <p className="text-gray-700">
                  ...
                  <em>active</em> hive. When you tap, the app resolves that
                  exact hive—no risk of mixing tags, even with hives close
                  together at the same apiary.
                </p>
                <ul className="list-disc pl-6">
                  <li>
                    <strong>Support:</strong> Web NFC works on Chrome for
                    Android. iOS Safari and many desktops don’t support Web
                    NFC—use the standard flow instead, or tags pre-encoded with
                    a URL that opens the <strong>Scan NFC</strong> page.
                  </li>
                  <li>
                    <strong>Linking:</strong> tap an unlinked tag →{" "}
                    <em>New Hive</em> with its ID locked; select the apiary and
                    save to bind that tag to the hive.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Scan page messages:</strong> the{" "}
                    <strong>Scan NFC</strong> page shows clear messages if your
                    device doesn’t support Web NFC, if permission is blocked, if
                    a scan is cancelled, if a tag is unknown, or if a tag is
                    linked to an archived hive. You’re always told what
                ...
                <p className="text-gray-700 text-sm">
                  For a printable step-by-step guide to ship with tags or save
                  as PDF, use the{" "}
                  <Link
                    to="/nfc/instructions"
                  ...
                  page. It’s designed as an A4-style card you can print and
                  include in the envelope with each HiveTag order.
                </p>
                <p className="text-gray-700 text-xs">
                  At the bottom of the <strong>Scan NFC</strong> page there is
                  an optional <em>“Show debug info”</em> toggle for
                  troubleshooting. It shows raw tag details (serial number,
                  record types) and the last error/lookup result. Most
                  beekeepers can ignore this; it’s mainly useful if you’re
                  diagnosing device/browser issues.
                </p>
              </div>
            </section>
            ...
            <section id="weather-maps-photos">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  ...
                  photo; Inspections allow up to <strong>3</strong>. Click
            ...
            <section id="filters-counts-archives">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Dashboard counts:</strong> Apiaries = global{" "}
                  <em>active</em> apiaries; Hives/Inspections/Tasks/Logbook
                ...
                <li>
                  <strong>After downgrade to Free:</strong> extra apiaries/hives
                  are auto-archived. You can view/export them, but cannot
                  unarchive beyond Free limits until you upgrade.
                </li>
              </ul>
              ...
              <div className="mt-4 p-4 rounded-lg border bg-white">
                ...
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
                  <li>
                    <strong>Archiving an Apiary</strong> also archives all of
                    its Hives and their Inspections. Tasks and Logbook entries
                    linked to those archived Hives/Inspections are archived too.
                  </li>
                  <li>
                    <strong>Archiving a Hive</strong> also archives all
                    Inspections for that Hive. Tasks/Logbook entries that
                    reference that Hive or those Inspections are archived.
                  </li>
                  <li>
                    <strong>Archiving a single Inspection</strong> archives any
                    Tasks or Logbook entries linked to that Inspection. The
                    parent Hive/Apiary remain active.
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
                  <li>
                    On <Badge>Free</Badge>, unarchiving is allowed only if it
                    won’t exceed the limits (max{" "}
                    <strong>1 active Apiary</strong>,{" "}
                    <strong>2 active Hives</strong> total).
                  </li>
                  <li>
                    Unarchiving a parent (e.g., Apiary → Hive → Inspection) may
                    prompt you to unarchive its children; if limits are
                ...
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
                  <li>
                    It does <strong>not delete</strong> data. You can still view
                    it in <em>Archive</em> and include it in CSV exports.
                  </li>
                  <li>
                    Public photo URLs remain accessible unless you delete the
                    files from storage.
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
                  <li>
                    Before downgrading, manually archive extra Apiaries/Hives so
                    you choose which stay active on Free.
                  </li>
                  <li>
                    Use the <em>Archive</em> page as your “history” area—keep
                    current operations uncluttered while preserving full
                    records.
                  </li>
                </ul>
              </div>
            ...
            <section id="tips">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  Use consistent hive names (e.g., “Hive A2”, “Blue Queen
                  2024”).
                </li>
                <li>
                  Capture next-visit actions in <strong>Tasks</strong> and give
                  them clear due dates.
                </li>
                <li>
                ...
                <li>
                  Filtering by apiary updates the page URL—bookmark or share
                  filtered views.
                </li>
              </ul>
            </section>
            ...
            <section id="faqs">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700">
                    Yes. NFC <Badge tone="blue">Premium</Badge> just speeds up
                    hive selection.
                  </p>
                </div>
                <div>
                  <p className="font-medium">
                    What exactly do I get on Free?
                  </p>
                  <p className="text-gray-700">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    We keep 1 active apiary (preferring your default) and up to
                    2 active hives within it; everything else is auto-archived.
                    Your data remains available to view/export. Upgrade again to
                    reactivate more.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-700">
                    Free limits enforce 1 active apiary and 2 active hives.{" "}
                    Unarchiving beyond that is blocked while on Free. Upgrade to
                    activate more.
                  </p>
                </div>
                <div>
                  <p className="font-medium">
                    How do I manage billing or cancel?
                  </p>
                  <p className="text-gray-700">
                    Go to <strong>Settings → Manage billing</strong>. This opens
                    the Stripe Customer Portal to update your card, download
                    invoices, or cancel.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    <em>Export my data (CSV)</em>. You’ll get separate CSV files
                    for your tables plus <code>photos.csv</code> with public
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Your device/browser likely doesn’t support Web NFC (e.g.,
                    iOS Safari). Use the normal New Inspection flow or tags
                    encoded with a URL that opens the{" "}
                    <strong>Scan NFC</strong> page.
                  </p>
                </div>
                <div>
                  <p className="font-medium">
            ...
            <section id="troubleshooting">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Can’t add another apiary/hive:</strong> Free plan
                  allows 1 active apiary and 2 active hives total. Upgrade to
                  add more.
                </li>
                <li>
                  <strong>Can’t unarchive an apiary/hive on Free:</strong>{" "}
                  limits apply on Free. Upgrade to reactivate more.
                </li>
                <li>
                  <strong>Can’t save Apiary/Hive/Inspection:</strong> fill
                  required fields; wait for photo upload; confirm you’re signed
                  in.
                </li>
                <li>
                  <strong>Task didn’t change to Completed:</strong> set status
                  from the Task List (Mark complete) or the Edit Task page.
                </li>
                <li>
                  <strong>
                    Can’t find the right inspection in the Logbook’s Related
                    Inspection list:
                  </strong>{" "}
                  pick the correct date group, then look for the option labelled{" "}
                  <em>Hive (Apiary) • time</em>; switch the Hive selector above
                  to narrow results.
                </li>
                <li>
                  <strong>NFC permission blocked:</strong> if the browser shows
                  that NFC access was denied, you’ll see a message on the{" "}
                  <strong>Scan NFC</strong> page. Re-enable NFC permissions for
                  your browser/site and try again.
                </li>
                <li>
                  <strong>NFC scan cancelled or no tag detected:</strong> if you
                  move away before a tag is read, the scan is cancelled and
                  you’ll see a note telling you no tag was read. Start another
                  scan and hold your phone steady over the tag until it beeps or
                  vibrates.
                </li>
                <li>
                ...
                <li>
                  ...
                  an existing active hive, the app resolves that hive and opens{" "}
                  <strong>New Inspection</strong> for it. If it’s linked to an
                  archived hive, you’ll see a message telling you to unarchive
                ...
                <li>
                  ...
                  download permissions/pop-up blocker and retry.
                </li>
              </ul>
            </section>
            ...
            <section id="privacy">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  ...
                  download CSVs of your data anytime.
                </li>
                <li>
                  <strong>Deletion</strong>: <em>Settings → Delete Account</em>{" "}
                  cancels any subscription, removes storage files, deletes your
                  tables, and deletes the auth user.
                </li>
                <li>
            ...
            <section id="power-users">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Plan enforcement:</strong> inserts and unarchives are
                  constrained on Free (1 apiary / 2 hives). Downgrade
                  auto-archives extras; upgrade lifts limits.
                </li>
                <li>
                  <strong>NFC scan routing:</strong> unlinked tag →{" "}
                  <em>New Hive</em>; once linked, every tap on that tag takes
                  you directly to <em>New Inspection</em> for the associated
                  hive. <Badge tone="blue">Premium</Badge>
                </li>
                <li>
              ...
              <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3">
                ...
                <div>
                  ...
                  <dd className="text-gray-700">
                    Individual bee colony housing.
                  </dd>
                </div>
                <div>
                  <dt className="font-medium">Inspection</dt>
                  <dd className="text-gray-700">
                    Structured record of a hive’s status.
                  </dd>
                </div>
                <div>
                  <dt className="font-medium">NFC</dt>
                  <dd className="text-gray-700">
                    Near Field Communication—tap a tag to identify the hive
                    (Premium).
                  </dd>
                </div>
                <div>
